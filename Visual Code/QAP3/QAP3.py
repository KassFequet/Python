...
# Date(s): February 7/25 - February 14/25
...
while True:
    ...
    #This is the section of optional calculations.
    ...
    # Display results
    print()
    TopInvDateDsp = (CUR_DATE.strftime("%B %d, %Y"))
    print(f"Honest Harry Car Sales                           Invoice Date: {TopInvDateDsp:<20s}")
    ...
    print(f"         ------------------------------------------------------------")
    InvDateDsp = (CUR_DATE.strftime("%d-%b-%y").upper())
    PayDateDsp = (PayDate.strftime("%d-%b-%y").upper())
    print(f"         Invoice date: {InvDateDsp:<10s}       First payment date: {PayDateDsp:<10s} ")
    print(f"--------------------------------------------------------------------------------")
